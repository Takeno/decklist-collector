...
export default async function handler(
  ...
  await transporter.sendMail({
    from: 'Austrian Legacy League <decklist@mg.magic-events.gg>',
                                ...
                                <tr>
                                  <td class="pad" style="width:100%;text-align:center;">
                                    <h1
                                      ...
                                      Welcome to Austrian Legacy League!</h1>
                                  </td>
                                </tr>
                              </table>
                                ...
                                <tr>
                                  <td class="pad">
                                    <div align="center" class="alignment">
                                      <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://austrianlegacy.magic-events.gg" style="height:38px;width:184px;v-text-anchor:middle;" arcsize="11%" stroke="false" fillcolor="#3AAEE0"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:14px"><![endif]--><a
                                        href="https://austrianlegacy.magic-events.gg"
